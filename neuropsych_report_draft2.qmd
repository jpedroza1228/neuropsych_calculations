...
Current Functioning: `r `
`r city`
`r state`

Medical History: The patient's medical history is significant for `r major_medical_issues`. `r medical_history`

Current Medications: Per `r mr_ms` `r patient_name`'s report, `r he_she` is `r current_medications`. `r he_she` mentioned a previous prescription of `r past_medications`.

Family History:

Psychiatric History and Substance Use: `r psychiatric_history`

`r substance_use_history`

Developmental, Educational, Social, and Occupational History: `r `
